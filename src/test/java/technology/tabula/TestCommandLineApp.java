...
public class TestCommandLineApp {
    ...
    public void testExtractSpreadsheetWithArea() throws ParseException, IOException {
        ...
        assertEquals(expectedCsv,
                this.csvFromCommandLineArgs(
                        new String[] { "src/test/resources/technology/tabula/spreadsheet_no_bounding_frame.pdf", "-p",
                                "1", "-a", "150.56,58.9,654.7,536.12", "-f", "CSV" }));
    }
    ...
    public void testExtractBatchSpreadsheetWithArea() throws ParseException, IOException {
        ...
        this.csvFromCommandLineArgs(
                new String[] { "-b", tmpFolder.toString(), "-p", "1", "-a", "150.56,58.9,654.7,536.12", "-f", "CSV" });
    ...
    public void testExtractSpreadsheetWithAreaAndNewFile() throws ParseException, IOException {
        ...
        this.csvFromCommandLineArgs(
                new String[] { "src/test/resources/technology/tabula/spreadsheet_no_bounding_frame.pdf", "-p", "1",
                        "-a", "150.56,58.9,654.7,536.12", "-f", "CSV", "-o", newFile.getAbsolutePath() });
    ...
    public void testExtractJSONWithArea() throws ParseException, IOException {
        ...
        String expectedJson = UtilsForTesting
                .loadJson("src/test/resources/technology/tabula/json/spanning_cells_basic.json");

        assertEquals(expectedJson,
                this.csvFromCommandLineArgs(new String[] { "src/test/resources/technology/tabula/spanning_cells.pdf",
                        "-p", "1", "-a", "150.56,58.9,654.7,536.12", "-f", "JSON" }));
    }
    ...
    public void testExtractCSVWithArea() throws ParseException, IOException {
        ...
        assertEquals(expectedCsv,
                this.csvFromCommandLineArgs(new String[] { "src/test/resources/technology/tabula/spanning_cells.pdf",
                        "-p", "1", "-a", "150.56,58.9,654.7,536.12", "-f", "CSV" }));
    }

    @Test
    public void testGuessOption() throws ParseException, IOException {
        String expectedCsvNoGuessing = UtilsForTesting
                .loadCsv("src/test/resources/technology/tabula/csv/TestCommandLineApp_testGuessOption_no_guessing.csv");
        assertEquals(expectedCsvNoGuessing,
        ...
        assertEquals(expectedCsvWithGuessing,
                this.csvFromCommandLineArgs(new String[] {
                        "src/test/resources/technology/tabula/icdar2013-dataset/competition-dataset-eu/eu-001.pdf",
                        "-p", "1", "-f", "CSV", "-g" }));
    }
    ...
    public void testEncryptedPasswordSupplied() throws ParseException {
        String s = this.csvFromCommandLineArgs(new String[] { "src/test/resources/technology/tabula/encrypted.pdf",
                "-s", "userpassword", "-p", "1", "-f", "CSV" });
    ...
    public void testExtractWithMultiplePercentArea() throws ParseException, IOException {
        ...
        assertEquals(expectedCsv,
                this.csvFromCommandLineArgs(new String[] { "src/test/resources/technology/tabula/MultiColumn.pdf", "-p",
                        "1", "-a", "%0,0,100,50", "-a", "%0,50,100,100", "-f", "CSV" }));
    }
    ...
    public void testExtractWithMultipleAbsoluteArea() throws ParseException, IOException {
        ...
        assertEquals(expectedCsv,
                this.csvFromCommandLineArgs(new String[] { "src/test/resources/technology/tabula/MultiColumn.pdf", "-p",
                        "1", "-a", "0,0,451,212", "-a", "0,212,451,425", "-f", "CSV" }));
    }
    ...
    public void testExtractWithPercentAndAbsoluteArea() throws ParseException, IOException {
        ...
        assertEquals(expectedCsv,
                this.csvFromCommandLineArgs(new String[] { "src/test/resources/technology/tabula/MultiColumn.pdf", "-p",
                        "1", "-a", "%0,0,100,50", "-a", "0,212,451,425", "-f", "CSV" }));
    }
    ...
    public void testLatticeModeWithColumnOption() throws ParseException, IOException {
        ...
        assertEquals(expectedCsv,
                this.csvFromCommandLineArgs(new String[] { "src/test/resources/technology/tabula/AnimalSounds.pdf",
                        "-p", "1", "-c", "59,218,331,551", "-r", "-f", "CSV" }));
    }
    ...
    public void testLatticeModeWithColumnAndMultipleAreasOption() throws ParseException, IOException {
        ...
        String resultJson = this.csvFromCommandLineArgs(new String[] {
                "src/test/resources/technology/tabula/AnimalSounds1.pdf", "-p", "1", "-c",
                "57,136,197,296,314,391,457,553", "-a", "%0,0,100,50", "-a", "%0,50,100,100", "-r", "-f", "JSON" });
